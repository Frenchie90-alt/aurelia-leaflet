define(['exports', 'aurelia-framework', 'aurelia-event-aggregator', './aurelia-leaflet-exceptions', './leaflet-defaults', './helpers/layer-factory', 'leaflet'], function (exports, _aureliaFramework, _aureliaEventAggregator, _aureliaLeafletExceptions, _leafletDefaults, _layerFactory, _leaflet) {
  ...
  }(), _class3.inject = [_leaflet.Leaflet, _aureliaEventAggregator.EventAggregator, Element], _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, 'layers', [_aureliaFramework.bindable], {
    enumerable: true,
    initializer: null
