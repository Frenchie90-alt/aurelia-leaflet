define(['exports', 'aurelia-framework', 'aurelia-event-aggregator', './aurelia-leaflet-exceptions', './leaflet-defaults', './helpers/layer-factory', 'leaflet'], function (exports, _aureliaFramework, _aureliaEventAggregator, _aureliaLeafletExceptions, _leafletDefaults, _layerFactory, _leaflet) {
  ...
  var LeafletCustomElement = exports.LeafletCustomElement = (_dec = (0, _aureliaFramework.customElement)('leaflet'), _dec2 = (0, _aureliaFramework.useView)('./leaflet.html'), _dec(_class = _dec2(_class = (_class2 = (_temp = _class3 = function () {
    function LeafletCustomElement(leaflet, eventAggregator, element) {
      ...
      _classCallCheck(this, LeafletCustomElement);
      ...
      this.layerFactory = new _layerFactory2.default(this.L);
  ...
  }(), _class3.inject = [_leaflet2.default, _aureliaEventAggregator.EventAggregator, Element], _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, 'layers', [_aureliaFramework.bindable], {
    enumerable: true,
    initializer: null
