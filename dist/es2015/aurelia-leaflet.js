...
export let LeafletCustomElement = (_dec = customElement('leaflet'), _dec2 = useView('./leaflet.html'), _dec(_class2 = _dec2(_class2 = (_class3 = (_temp = _class4 = class LeafletCustomElement {
...
let LayerFactory = class LayerFactory {
