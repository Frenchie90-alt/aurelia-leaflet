...
export let LeafletCustomElement = (_dec = customElement('a-leaflet'), _dec2 = useView('./leaflet.html'), _dec3 = inject(Leaflet, EventAggregator, Element), _dec(_class = _dec2(_class = _dec3(_class = (_class2 = class LeafletCustomElement {
